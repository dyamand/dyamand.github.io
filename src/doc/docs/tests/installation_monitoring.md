...
type Installation {
	...
	id: String!
	# Unique names of the installation.
	names: Names!
...
# Indicates the health of the current installation.
type Health {
...
# Status an installation can be in.
enum Status {
	# Everything is OK with this installation.
	ONLINE
	# This installation has announced that it would be going offline.
	OFFLINE
	# Lost communication with the installation.
	LOST_COMMUNICATION
}
