...
!!! success "_e.7.0.E.1_ When a client executes a subscription without a subscription ID, the subscription should fail with a 400 status code"
!!! success "_e.7.0.E.2_ When a client executes a subscription with a subscription ID and the subscription ID is not registered, the subscription should fail with a 400 status code"
